...
export const translations = {
  lo: {
    ...
    registrationDeadlineLabel: "ກຳນົດປິດຮັບສະໝັກ",
    registrationDeadlineInputLabel: "ກຳນົດປິດຮັບສະໝັກ (Registration Deadline)",
    registrationDeadlineInputHelp: "ເລືອກວັນທີປິດຮັບສະໝັກ (ລະບົບຈະຄິດໄລ່ວັນໃນສັບປະດາ ແລະ ເດືອນໃຫ້ອັດຕະໂນມັດ)",
    registrationDeadlineCardDesc: "ກຳນົດວັນທີປິດຮັບສະໝັກສອບເສັງທີ່ສະແດງໃນໜ້າຫຼັກ",
...
// Login Modal
  ...
  en: {
    ...
    registrationDeadlineInputLabel: "Registration Deadline",
    registrationDeadlineInputHelp: "Select the official registration deadline (system auto-formats day of week and month)",
    registrationDeadlineCardDesc: "Registration deadline date displayed on the public portal",
