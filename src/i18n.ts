...
export const translations = {
  lo: {
    ...
    formsSoldLabel: "ຟອມທີ່ຂາຍແລ້ວ",
    usedFormsLabel: "ຟອມທີ່ຂາຍແລ້ວ",
    totalRegisteredLabel: "ຜູ້ສະໝັກທີ່ລົງທະບຽນ",
    remainingFormsLabel: "ຟອມທີ່ຍັງເຫຼືອ",
    unifiedFormBadge: "ໂຄຕ້າຟອມລວມ (ບໍ່ແຍກລະດັບ)",
    levelInfoTitle: "ລາຍລະອຽດແຕ່ລະລະດັບ (JLPT N5 - N1)",
    levelInfoDesc: "ສະແດງຈຳນວນບ່ອນນັ່ງທີ່ຍັງເຫຼືອ, ເວລາສອບເສັງ ແລະ ຄ່າສະໝັກໃນແຕ່ລະລະດັບ",
    ...
    registrationStatusLabel: "ສະຖານະການລົງທະບຽນ",
    registrationStatusDesc: "ການຄວບຄຸມແຕ່ງທໍາອິດວ່າປິດ ຫຼື ເປີດການລົງທະບຽນ",
    ...
    examTimeField: "ເວລາສອບເສັງ",
    examFeeField: "ຄ່າສະໝັກສອບເສັງ",
    lakUnit: "ກີບ (LAK)",
    ...
    viewExamRoomPhotoBtn: "ເບິ່ງຮູບພາບຫ້ອງສອບເສັງ",
...
// Rooms Section
    ...
    searchByNameHint: "ພິມຊື່ແລະ ນາມສະກຸນຂອງທ່ານ ເພື່ອກວດເບິ່ງຫ້ອງສອບຂອງທ່ານ",
    buildingLabel: "ອາຄານ",
    floorLabel: "ຊັ້ນ",
    levelLabel: "ລະດັບ",
    ...
    noRoomsFound: "ບໍ່ພົບຂໍ້ມູນຫ້ອງສອບເສັງຂອງທ່ານ",
    ...
    candidateNameCol: "ຊື່ແລະ ນາມສະກຸນ (Full Name)",
    orderCol: "ລຳດັບ",
    closeBtn: "ປິດໜ້າຕ່າງ",
...
// Manage Examinees in Admin
    ...
    addExamineeTitle: "ເພີ່ມຜູ້ສອບເສັງໃນຫ້ອງ",
    batchAddExamineeBtn: "+ ນຳເຂົ້າຫຼາຍຄົນ (Batch)",
    firstNameLabel: "ຊື່ (First Name)",
    lastNameLabel: "ນາມສະກຸນ (Last Name)",
    fullNameLabel: "ຊື່ແລະ ນາມສະກຸນ (Full Name)",
    fullNamePlaceholder: "ກະລຸນາປ້ອນຊື່ແລະ ນາມສະກຸນ (ວິທີຢ່າງ: ວິໄລພອນ ວົງສະຫວັນ / Vilaiphone Vongsavanh)",
    fullNameRequiredError: "ກະລຸນາປ້ອນຊື່ແລະ ນາມສະກຸນຜູ້ສອບເສັງ",
    batchAddTitle: "ນຳເຂົ້າລາຍຊື່ຜູ້ສອບເສັງແບບຊຸດ (Batch Import)",
    batchAddInstruction: "ວາງລາຍຊື່ແລະ ນາມສະກຸນຜູ້ສອບເສັງ 1 ຄົນຕໍ່ 1 ແຖວ",
    batchAddPlaceholder: "ສົມສັກ ແກ້ວມະນີ\nມະນີວັນ ພອນປະເສີດ\nSengdao Khammany",
    batchAddSuccess: "ເພີ່ມຜູ້ສອບເສັງ {count} ຄົນແລ້ວ!",
    batchAddError: "ກະລຸນາປ້ອນຊື່ຕໍ່ໄປຢ່າງໜ້ອຍ 1 ຊື່",
    ...
    csvFormatHint: "ຮອງຮັບໄຟລ໌ .csv (UTF-8) ທີ່ມີຄໍລຳ: ຊື່ແລະ ນາມສະກຸນ ຫຼື ຊື່, ນາມສະກຸນ ຫຼື First Name, Last Name",
...
// Login Modal
    ...
    infoBoardTitle: "ກະດານຂ່າວ ແລະ ປະກາດສຳຄັນ",
    infoBoardSubtitle: "ແຈ້ງການ, ໂປສເຕີ ແລະ ຂໍ້ມູນສຳຄັນສຳລັບຜູ້ເຂົ້າສອບເສັງ",
    postAnnouncementBtn: "ເພີ່ມປະກາດ / ໂປສເຕີໃໝ່",
    editAnnouncementBtn: "ແກ້ໄຂ",
    deleteAnnouncementBtn: "ລຶບ",
    pinnedBadge: "ປັກໝຸດ",
    pinToTopLabel: "ປັກໝຸດໄວ້ເທິງສຸດ",
    announcementTitleLabel: "ຫົວຂໍ້ປະກາດ",
    announcementTitlePlaceholder: "ເຊັ່ນ: ລະບຽບການສອບເສັງ, ຕາຕະລາງສອບ, ເອກະສານທີ່ຕ້ອງນຳມາ...",
    announcementContentLabel: "ເນື້ອໃນລາຍລະອຽດ",
    announcementContentPlaceholder: "ຂຽນລາຍລະອຽດປະກາດ ຫຼື ຂໍ້ຄວາມແນະນຳທີ່ນີ້...",
    posterImageLabel: "ຮູບພາບໂປສເຕີ / ປ້າຍປະກາດ (ຖ້າມີ)",
    uploadPosterBtn: "ເລືອກຮູບໂປສເຕີ",
    changePosterBtn: "ປ່ຽນຮູບໂປສເຕີ",
    removePosterBtn: "ລຶບຮູບ",
    noAnnouncementsMessage: "ຍັງບໍ່ມີປະກາດໃນຂະນະນີ້",
    confirmDeleteAnnouncement: "ທ່ານແນ່ໃຈບໍ່ວ່າຕ້ອງການລຶບປະກາດນີ້?",
    viewFullPosterBtn: "ເບິ່ງຮູບຂະໜາດເຕັມ",
    modalAddAnnouncementTitle: "ເພີ່ມປະກາດ ຫຼື ໂປສເຕີໃໝ່",
    modalEditAnnouncementTitle: "ແກ້ໄຂປະກາດ / ໂປສເຕີ",
    saveAnnouncementBtn: "ບັນທຶກປະກາດ",
    manageAnnouncementsTitle: "ຈັດການກະດານຂ່າວ & ໂປສເຕີ",
    manageAnnouncementsDesc: "ໂພສປະກາດ, ອັບໂຫຼດຮູບໂປສເຕີ ແລະ ແຈ້ງການຕ່າງໆໃຫ້ຜູ້ສອບເສັງເຫັນ",
    announcementSavedSuccess: "ບັນທຶກປະກາດສຳເລັດແລ້ວ!",
    announcementDeletedSuccess: "ລຶບປະກາດສຳເລັດແລ້ວ!",
  ...
  en: {
    ...
    formsSoldLabel: "Forms Sold",
    usedFormsLabel: "Forms Sold",
    totalRegisteredLabel: "Registered Applicants",
    ...
    levelInfoDesc: "Remaining seats, exam schedule, and fees per level",
    ...
    registrationStatusDesc: "Manually control whether registration is open or closed",
    ...
    viewExamRoomPhotoBtn: "View Exam Room Photo",
    ...
    noRoomsFound: "No examination room found for your search",
    ...
    fullNamePlaceholder: "Enter full name (e.g. Vilaiphone Vongsavanh)",
    fullNameRequiredError: "Please enter examinee's full name",
    addExamineeTitle: "Add Examinee to Room",
    batchAddTitle: "Batch Import Examinees",
    batchAddInstruction: "Paste examinee full names, one per line",
    batchAddPlaceholder: "Somxay Keomany\nManivanh Phonpaseuth\nSengdao Khammany",
    batchAddSuccess: "Successfully added {count} examinees!",
    batchAddError: "Please enter at least one name",
    ...
    csvFormatHint: "Supports .csv (UTF-8) with columns: Full Name (or First Name, Last Name)",
    ...
    // Information Board & Announcements
    infoBoardTitle: "Notice Board & Announcements",
    infoBoardSubtitle: "Important notices, posters, and instructions for examinees",
    postAnnouncementBtn: "Post Announcement / Poster",
    editAnnouncementBtn: "Edit",
    deleteAnnouncementBtn: "Delete",
    pinnedBadge: "Pinned",
    pinToTopLabel: "Pin to top",
    announcementTitleLabel: "Announcement Title",
    announcementTitlePlaceholder: "e.g. Exam rules, schedule notice, required documents...",
    announcementContentLabel: "Detailed Content",
    announcementContentPlaceholder: "Write announcement details or instructions here...",
    posterImageLabel: "Poster / Notice Image (Optional)",
    uploadPosterBtn: "Upload Poster Image",
    changePosterBtn: "Change Poster",
    removePosterBtn: "Remove Image",
    noAnnouncementsMessage: "No announcements posted yet",
    confirmDeleteAnnouncement: "Are you sure you want to delete this announcement?",
    viewFullPosterBtn: "View Full Size",
    modalAddAnnouncementTitle: "Post New Announcement / Poster",
    modalEditAnnouncementTitle: "Edit Announcement / Poster",
    saveAnnouncementBtn: "Save Announcement",
    manageAnnouncementsTitle: "Manage Information Board & Posters",
    manageAnnouncementsDesc: "Post announcements, upload poster images, and notify examinees",
