...
// Rooms Section
    ...
    candidateNameCol: "ຊື່ເຕັມ (Full Name)",
    orderCol: "ລຳດັບ",
    closeBtn: "ປິດໜ້າຕ່າງ",
...
// Manage Examinees in Admin
    ...
    fullNameLabel: "ຊື່ເຕັມ (Full Name)",
    fullNamePlaceholder: "ກະລຸນາປ້ອນຊື່ເຕັມ (ວິທີຢ່າງ: ວິໄລພອນ ວົງສະຫວັນ / Vilaiphone Vongsavanh)",
    fullNameRequiredError: "ກະລຸນາປ້ອນຊື່ເຕັມຜູ້ສອບເສັງ",
    batchAddTitle: "ນຳເຂົ້າລາຍຊື່ຜູ້ສອບເສັງແບບຊຸດ (Batch Import)",
    batchAddInstruction: "ວາງລາຍຊື່ເຕັມຜູ້ສອບເສັງ 1 ຄົນຕໍ່ 1 ແຖວ",
    ...
    csvFormatHint: "ຮອງຮັບໄຟລ໌ .csv (UTF-8) ທີ່ມີຄໍລຳ: ຊື່ເຕັມ ຫຼື ຊື່, ນາມສະກຸນ ຫຼື First Name, Last Name",
